<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="displayTables" row-key="tableName" style="width: 100%; margin-top: 20px" height="60vh" border>
      ...
      <el-table-column label="操作" width="220">
        <template #default="scope">
          ...
          <el-button type="warning" size="small" @click="handleCollectTable(scope.row.tableName)">采集</el-button>
        </template>
      </el-table-column>
    </el-table>
