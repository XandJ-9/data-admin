...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name'], name='dataasset_d_name_cc0358_idx'),
        ),
        migrations.AddIndex(
            model_name='datasource',
            index=models.Index(fields=['db_type'], name='dataasset_d_db_type_d0e0ab_idx'),
        ),
        migrations.AddIndex(
            model_name='datasource',
            index=models.Index(fields=['status'], name='dataasset_d_status_9cdf07_idx'),
        ),
        migrations.AddIndex(
            model_name='datasource',
            index=models.Index(fields=['del_flag'], name='dataasset_d_del_fla_891397_idx'),
        ),
    ]
